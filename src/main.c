...
module_param_cb(add_device, &add_device_ops, NULL, 0644);

MODULE_PARM_DESC(remove_device, "In runtime: remove device");
module_param_cb(remove_device, &remove_device_ops, NULL, 0644);

MODULE_PARM_DESC(device_names, "In inserting module: add list of devices / In runtime: get devices list");
module_param_array(device_names, charp, &curr_amount, 0444);
